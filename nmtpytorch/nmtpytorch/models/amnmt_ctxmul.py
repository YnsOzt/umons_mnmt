...
from ..layers import TextEncoderCTXMUL, ConditionalDecoder
...
class AttentiveMNMTFeaturesCTXMUL(NMT):
    """An end-to-end sequence-to-sequence NMT model with visual attention over
    pre-extracted convolutional features. this class uses the CTXMUL technique for merging the
    visual features to the text.
    method described in :
    https://arxiv.org/pdf/1707.04481.pdf?fbclid=IwAR2U9oS5z3SzVUdH0aLvyEQt36-cl_MaVGT3AThqOfXPaAslr8_LUC_YlmU
    """
