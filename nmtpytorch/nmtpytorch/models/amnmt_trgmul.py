...
from ..layers import TextEncoder, ConditionalMMDecoderTRGMUL
...
class AttentiveMNMTFeaturesTRGMUL(NMT):
    """An end-to-end sequence-to-sequence NMT model with visual attention over
    pre-extracted convolutional features. this class uses the TRGMUL technique for merging the
