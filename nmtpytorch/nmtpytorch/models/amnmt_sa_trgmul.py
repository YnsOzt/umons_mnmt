...
from ..layers import SATextEncoder, ConditionalMMDecoderTRGMUL
...
class AttentiveMNMTFeaturesSATRGMUL(NMT):
    ...
    def setup(self, is_train=True):
        ...
        #attention flatten
        self.attflat_img = AttentionFlatten(self.opts.model['n_channels'], self.opts.model['flat_mlp_size'], 1, self.opts.model['n_channels'])  
